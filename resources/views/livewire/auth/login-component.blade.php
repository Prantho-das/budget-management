         ...
         <div class="login-form-box">
            ...
            <form wire:submit="login">
                ...
                <div class="form-group">
                    ...
                    <input type="email" wire:model="email" id="email" placeholder="Type your email/ mobile no./ user id" class="form-control" required autofocus >
                ...
                <div class="form-group">
                    ...
                    <input type="password" wire:model="password" id="password" placeholder="Type  password" class="form-control" required>
                 ...
                 <div class="form-group">
                    ...
                    <input type="number" wire:model="captcha" id="captcha" placeholder="Type result" class="form-control captcha-control" required>
                    <div class="icon">
                ...
                <div class="form-group">
                    <button type="submit" class="btn login-btn" wire:loading.attr="disabled">
