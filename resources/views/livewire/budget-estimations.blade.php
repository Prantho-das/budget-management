                    ...
                    <table class="table align-middle mb-0">
                        <thead class="table-light text-uppercase font-size-11">
                            <tr>
                                ...
                                @endphp
                                @foreach ($prevYears as $py)
                                    <th style="width: 10%;" class="text-end text-muted">{{ __('Exp') }}<br><span
                                            class="font-size-10">{{ $py->name }}</span></th>
                                @endforeach
                        ...
                        <tbody>
                            ...
                            @foreach ($economicCodes as $code)
                                <tr
                                    class="{{ $code->parent_id ? '' : 'table-light fw-bold font-size-13 border-top' }}">
                                    ...
                                    <td>
                                        ...
                                        @if ($code->description)
                                            <small class="text-muted d-block text-truncate"
                                                style="max-width: 200px;">{{ $code->description }}</small>
                                        @endif
                                    </td>
                                    @for ($i = 0; $i < 3; $i++)
                                    ...
                                    <td class="ps-4">
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="number" step="0.01"
                                                ...
                                                wire:model.defer="demands.{{ $code->id }}" placeholder="0.00"
                                                {{ $status !== 'draft' && $status !== 'rejected' ? 'disabled' : '' }}>
                                        </div>
                                    </td>
                                    <td>
