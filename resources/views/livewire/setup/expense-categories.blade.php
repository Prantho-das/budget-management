                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">{{ $category_id ? 'Edit' : 'Create' }} Category</h5>
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="code" wire:model="code" placeholder="Unique Code (e.g. 3211101)">
                            ...
                            <tbody>
                                @foreach($categories as $category)
                                    <tr>
                                        <td>{{ $category->id }}</td>
                                        <td>{{ $category->name }}</td>
                                        <td><span class="badge bg-success">{{ $category->code }}</span></td>
                                        <td>
