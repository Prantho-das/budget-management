            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <h4 class="card-title">Fiscal Year List</h4>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">{{ $fiscal_year_id ? 'Edit' : 'Create' }} Fiscal Year</h5>
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="name" wire:model="name" placeholder="e.g. 2025-2026">
                            ...
                            <tbody>
                                @foreach($fiscal_years as $fiscal)
                                    <tr>
                                        ...
                                        <td>
                                            <button wire:click="edit({{ $fiscal->id }})" class="btn btn-sm btn-info">Edit</button>
                                            <button wire:click="delete({{ $fiscal->id }})" class="btn btn-sm btn-danger">Delete</button>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
